...
// breaks the same way.
//
// A leading "^" is what makes Vite read the key as a RegExp. The nine names are
...
// and asserts this line matches it — a tenth router added without touching this
// file fails there rather than silently 404ing in dev only.
const MANAGE_API =
  "^/manage/(appointment-types|auth|availability|bookings|dresses|gateway|settings|slots|staff|terms)";
