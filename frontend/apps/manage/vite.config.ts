...
// breaks the same way.
//
// A leading "^" is what makes Vite read the key as a RegExp. The sixteen names
...
// table and asserts this line matches it — a seventeenth segment added without
// touching this file fails there rather than silently 404ing in dev only.
const MANAGE_API =
  "^/manage/(appointment-types|atelier|auth|availability|bookings|checkin-qr|customers|dashboard|dresses|floor|gateway|privacy|settings|slots|staff|terms)";
