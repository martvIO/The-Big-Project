...
| 42 | Seamstress capacity hours + load bars + balanced assignment | **done (PR #43)** | `.planning/specs/seamstress-capacity.md` | `.planning/plans/seamstress-capacity.md` | F41, F57 · *F40 dep dropped, design gate self-approved 2026-07-31* |
