...
| | |
|---|---|
| Rows in this deck | 1 (`document.book`) + 45 (`booking.*` from the spec's inventory) + 6 (`errors.*`) + 9 (additions, §4 — seven proposed + two added at sign-off) = **61** |
...
| Gate status | **APPROVED — 61 of 61 rows, 2026-07-29** |
