...
**Date**: 2026-07-29 · **Status**: **rev 4 — SIGNED OFF; every row APPROVED** (rev 4 = three build-time additions + `confirmCold` made conditional to satisfy R14 in full) · **Owner of the Hebrew: the user** · **Consumes**: `.planning/specs/storefront-booking-ui.md` §Design i18n inventory (verbatim key list) · **Lands in**: `Frontend/apps/storefront/src/i18n/he.ts`
